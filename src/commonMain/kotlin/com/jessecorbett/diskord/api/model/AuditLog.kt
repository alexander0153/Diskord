...
data class OptionalEntryData(
    @SerialName("delete_member_days") val pruneKickedAfterDays: String? = null,
    @SerialName("members_removed") val pruneMembersPrunedCount: String? = null,
    @SerialName("channel_id") val deleteChannelId: String? = null,
    @SerialName("count") val deleteMessageCount: String? = null,
    @SerialName("id") val overwriteEntityId: String? = null,
    @SerialName("type") val overwriteEntityType: OverwrittenEntityType? = null,
    @SerialName("role_name") val overwriteRoleName: String? = null
)
